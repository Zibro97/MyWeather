package com.example.myweather.presentation.appwidget
                ...
                .addOnSuccessListener { location->
                    lifecycleScope.launch{
                        try {
                            ...
                            val weather = RetrofitClient.WEATHER_API.weatherInfo(latitude = location.latitude,longitude = location.longitude)
                            val updateViews = RemoteViews(packageName,R.layout.widget_weather).apply {
